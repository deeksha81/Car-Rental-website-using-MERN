...
const Navbar = ({setShowLogin}) => {
  ...
  return (
    <div className= {`flex items-center justify-between px-6 md:px-16
                      lg:px-24 xl:px-32 py-4 text-gray-600 border-b border-borderColor relative 
        ...
        <div className={`max-sm:fixed max-sm:h-screen max-sm:w-full max-sm:top-16 
                           ...
                           max-sm:border-t border-borderColor 
                           right-0 flex flex-col sm:flex-row items-start 
            ...
            <div className='flex max-sm:flex-col items-start sm:items-center gap-6'>
              ...
              <button onclick = {()=> setShowLogin(true)}className='cursor-pointer px-8 py-2 bg-primary hover: bg-primary-dull transition-all text-white rounded-lg'>Logins</button>
            </div>
